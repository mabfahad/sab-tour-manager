 ...
 * @subpackage Sab_Tour_Manager/admin
 */
...
class Sab_Tour_Manager_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/sab-tour-manager-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/sab-tour-manager-admin.js', array( 'jquery' ), $this->version, false );
